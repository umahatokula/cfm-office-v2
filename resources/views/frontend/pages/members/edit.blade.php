...
<div class="content-wrapper">
  ...
  <div class="row">
    <div class="col-md-4 pull-right">
      <div class="card">
        <div class="card-body">
        <img src="{{ asset('/uploads/' . $member->picture_path) }}" class="img-cirlce img-responsive img-thumbnail" alt="{{$member->fname}}" />
        </div>
      </div>
    </div>
    <div class="col-md-8 pull-left">
      <div class="card">
        ...
        <div class="row">
          ...
          {!! Form::model($member, array('route' => array('members.update', $member->id), 'method' => 'PUT', 'class' => 'form-horizontal ajaxForm', 'role' => 'form', 'files' => true)) !!}
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              {!! Form::select('country_id', $countries, null, array('class' => 'form-control select', 'id' => 'country_id')) !!}
            </div>
          </div>
          ...
          <div class="form-group">
            {!! Form::label('state_id', 'State', array('class' => 'col-sm-4 control-label', 'for' => 'state_id')) !!}

            <div class="col-sm-8">
              {!! Form::select('state_id', $states, null, array('class' => 'form-control select', 'id' => 'state_id')) !!}
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              {!! Form::select('local_id', $locals, null, array('class' => 'form-control select', 'id' => 'local_id')) !!}
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              {!! Form::select('age_profile_id', $ageProfiles, null, array('class' => 'form-control', 'id' => 'age_profile_id', 'placeholder' => 'Age Profile')) !!}
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              {!! Form::select('church_id', $churches, null, array('class' => 'form-control', 'id' => 'church_id')) !!}
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              {!! Form::select('region_id', $regions, null, array('class' => 'form-control', 'id' => 'region_id', 'placeholder' => 'Select one')) !!}
            </div>
          </div>
