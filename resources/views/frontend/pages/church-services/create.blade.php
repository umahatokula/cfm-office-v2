  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-body">
        ...
        @endif
        {!! Form::open( array('route' => 'church-services.store', 'class' => 'ajaxForm', 'role' => 'form', 'id' => 'churchServiceForm')) !!}
        <div class="row">
          <fieldset>
            ...
            <div class="col-sm-6">
              ...
              {!! Form::date('service_date', null, array('class' => 'form-control', 'id' => 'service_date', 'required')) !!}
            </div>
          ...
          <fieldset>
            ...
            <div class="form-group">
              <div class="col-md-4">
                ...
                {!! Form::input('number','attendance_men', 0, array('class' => 'form-control', 'id' => 'attendance_men')) !!}

              </div>
              <div class="col-md-4">
                {!! Form::label('attendance_women', 'Women', array('class' => ' control-label', 'for' => 'attendance_women')) !!}

                {!! Form::input('number','attendance_women', 0, array('class' => 'form-control', 'id' => 'attendance_women')) !!}
              </div>
              <div class="col-md-4">
                {!! Form::label('attendance_children', 'Children', array('class' => ' control-label', 'for' => 'attendance_children')) !!}

                {!! Form::input('number','attendance_children', 0, array('class' => 'form-control', 'id' => 'attendance_children')) !!}
              </div>
            </div>
          </fieldset>
        </div>
          ...
          <fieldset>
            ...
            <div class="form-group">
              ...
              <div class="col-md-4">
                ...
                {!! Form::input('number','first_timers_men', 0, array('class' => 'form-control', 'id' => 'first_timers_men')) !!}
              </div>

              <div class="col-md-4">
                {!! Form::label('first_timers_women', 'Women', array('class' => 'control-label', 'for' => 'first_timers_women')) !!}

                {!! Form::input('number','first_timers_women', 0, array('class' => 'form-control', 'id' => 'first_timers_women')) !!}
              </div>

              <div class="col-md-4">
                {!! Form::label('first_timers_children', 'Children', array('class' => 'control-label', 'for' => 'first_timers_children')) !!}

                {!! Form::input('number','first_timers_children', 0, array('class' => 'form-control', 'id' => 'first_timers_children')) !!}
              </div>
          ...
          <fieldset>
            ...
            <div class="form-group">
              ...
              <div class="col-md-4">
                ...
                {!! Form::input('number','born_again_men', 0, array('class' => 'form-control', 'id' => 'born_again_men')) !!}
              </div>

              <div class="col-md-4">
                {!! Form::label('born_again_women', 'Women', array('class' => 'control-label', 'for' => 'born_again_women')) !!}

                {!! Form::input('number','born_again_women', 0, array('class' => 'form-control', 'id' => 'born_again_women')) !!}
              </div>

              <div class="col-md-4">
                {!! Form::label('born_again_children', 'Children', array('class' => 'control-label', 'for' => 'born_again_children')) !!}

                {!! Form::input('number','born_again_children', 0, array('class' => 'form-control', 'id' => 'born_again_children')) !!}
              </div>
          ...
          <fieldset>
            ...
            <div class="form-group">
              ...
              <div class="col-md-4">
                ...
                {!! Form::input('number','filled_men', 0, array('class' => 'form-control', 'id' => 'filled_men')) !!}
              </div>

              <div class="col-md-4">
                {!! Form::label('filled_women', 'Women', array('class' => 'control-label', 'for' => 'filled_women')) !!}

                {!! Form::input('number','filled_women', 0, array('class' => 'form-control', 'id' => 'filled_women')) !!}
              </div>

              <div class="col-md-4">
                {!! Form::label('filled_children', 'Children', array('class' => 'control-label', 'for' => 'filled_children')) !!}

                {!! Form::input('number','filled_children', 0, array('class' => 'form-control', 'id' => 'filled_children')) !!}
              </div>
          ...
          <fieldset>
            ...
            <div class="form-group">
              <div class="col-md-4">
                ...
                {!! Form::input('number','regular_offering', 0, array('class' => 'form-control', 'id' => 'regular_offering')) !!}
              </div>

              <div class="col-md-4">
                {!! Form::label('tithes', 'Tithes', array('class' => 'control-label', 'for' => 'tithes')) !!}

                {!! Form::input('number','tithes', 0, array('class' => 'form-control', 'id' => 'tithes')) !!}
              </div>

              <div class="col-md-4">
                {!! Form::label('connection', 'Connection', array('class' => 'control-label', 'for' => 'connection')) !!}

                {!! Form::input('number','connection', 0, array('class' => 'form-control', 'id' => 'connection')) !!}
              </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-4">
                ...
                {!! Form::input('number','first_fruit', 0, array('class' => 'form-control', 'id' => 'first_fruit')) !!}
              </div>
              <div class="col-md-4">
                {!! Form::label('thanksgiving_offering', 'Thanksgiving', array('class' => ' control-label', 'for' => 'thanksgiving_offering')) !!}

                {!! Form::input('number','thanksgiving_offering', 0, array('class' => 'form-control', 'id' => 'thanksgiving_offering')) !!}
              </div>
              <div class="col-md-4">
                {!! Form::label('special_offering', 'Special', array('class' => 'control-label', 'for' => 'special_offering')) !!}

                {!! Form::input('number','special_offering', 0, array('class' => 'form-control', 'id' => 'special_offering')) !!}
              </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-4">
                ...
                {!! Form::input('number','project_offering', 0, array('class' => 'form-control', 'id' => 'project_offering')) !!}
              </div>
              ...
              <div class="col-md-4">
                ...
                {!! Form::input('number','honourarium', 0, array('class' => 'form-control', 'id' => 'honourarium')) !!}
              </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-4">
                ...
                {!! Form::input('number','others', 0, array('class' => 'form-control', 'id' => 'others')) !!}
              </div>
