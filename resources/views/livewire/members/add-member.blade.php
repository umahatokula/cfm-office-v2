        ...
        <div class="row">
          ...
          <form wire:submit.prevent="save">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input wire:model="mname" type="text" class="form-control" id="mname">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    ...
                    @error('gender_id') <span class="error">{{ $message }}</span> @enderror
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input wire:model="occupation" type="text" class="form-control" id="occupation">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    ...
                    @error('local_id') <span class="error">{{ $message }}</span> @enderror
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <select wire:model="age_profile_id"  class="form-control mb-3">
                        <option value="">Select one...</option>
                        @foreach ($ageProfiles as $ageProfile)
                            <option value="{{ $ageProfile->id }}">{{ $ageProfile->name }}</option>
                        @endforeach
                    </select>
                    @error('age_profile_id') <span class="error">{{ $message }}</span> @enderror
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    ...
                    @error('church_id') <span class="error">{{ $message }}</span> @enderror
                </div>
            </div>
            ...
            <div class="row mb-3">
                <label for="region_id" class="col-sm-2 col-form-label">Regions</label>
                <div class="col-sm-10">
                    <select wire:model="region_id"  class="form-control mb-3">
                        <option value="">Select one...</option>
            ...
            <div class="row mb-3">
                <label for="cell_id" class="col-sm-2 col-form-label">Cell</label>
                <div class="col-sm-10">
                    <select wire:model="region_id"  class="form-control mb-3">
                        <option value="">Select one...</option>
                    ...
                    @error('cell_id') <span class="error">{{ $message }}</span> @enderror
                </div>
            </div>
