                ...
                <div class="row">
                    <div class="col-md-12" style="font-size: 1rem">
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-md-4">
                                ...
                                {!! Form::input('number','attendance_women', null, array('class' => 'form-control', 'id' =>
                                'attendance_women')) !!}
                            </div>
                            <div class="col-md-4">
                                ...
                                {!! Form::input('number','attendance_children', null, array('class' => 'form-control', 'id'
                                => 'attendance_children')) !!}
                            </div>
                        </div>
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-md-4">
                                ...
                                {!! Form::input('number','first_timers_men', null, array('class' => 'form-control', 'id' =>
                                'first_timers_men')) !!}
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                {!! Form::input('number','first_timers_women', null, array('class' => 'form-control', 'id'
                                => 'first_timers_women')) !!}
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                {!! Form::input('number','first_timers_children', null, array('class' => 'form-control',
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-md-4">
                                ...
                                {!! Form::input('number','born_again_men', null, array('class' => 'form-control', 'id' =>
                                'born_again_men')) !!}
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                {!! Form::input('number','born_again_women', null, array('class' => 'form-control', 'id' =>
                                'born_again_women')) !!}
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                {!! Form::input('number','born_again_children', null, array('class' => 'form-control', 'id'
                                => 'born_again_children')) !!}
                            </div>
                        </div>
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-md-4">
                                ...
                                {!! Form::input('number','filled_men', null, array('class' => 'form-control', 'id' =>
                                'filled_men')) !!}
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                {!! Form::input('number','filled_women', null, array('class' => 'form-control', 'id' =>
                                'filled_women')) !!}
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                {!! Form::input('number','filled_children', null, array('class' => 'form-control', 'id' =>
                                'filled_children')) !!}
                            </div>
                        </div>
                        <div class="row mb-5">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                {!! Form::input('number','regular_offering', null, array('class' => 'form-control', 'id' =>
                                'regular_offering')) !!}
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                {!! Form::input('number','tithes', null, array('class' => 'form-control', 'id' =>
                                'tithes')) !!}
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                {!! Form::input('number','connection', null, array('class' => 'form-control', 'id' =>
                                'connection')) !!}
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                {!! Form::input('number','first_fruit', null, array('class' => 'form-control', 'id' =>
                                'first_fruit')) !!}
                            </div>
                            <div class="col-md-4 mb-3">
                                ...
                                {!! Form::input('number','thanksgiving_offering', null, array('class' => 'form-control',
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                {!! Form::input('number','special_offering', null, array('class' => 'form-control', 'id' =>
                                'special_offering')) !!}
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                {!! Form::input('number','project_offering', null, array('class' => 'form-control', 'id' =>
                                'project_offering')) !!}
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                {!! Form::input('number','honourarium', null, array('class' => 'form-control', 'id' =>
                                'honourarium')) !!}
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                {!! Form::input('number','others', null, array('class' => 'form-control', 'id' =>
                                'others')) !!}
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12 text-center">
                            {!! Form::submit('Update service information', array('class' => 'btn btn-primary')) !!}
